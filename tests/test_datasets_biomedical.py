...
def test_write_to_conll():
    writer = CoNLLWriter(tokenizer=whitespace_tokenize,
                         sentence_splitter=lambda x: ([x], [0]))
    ...
    dataset = InternalBioNerDataset(
        ...
        entities_per_document={"1": [
            ...
            Entity((text.find("a long entity3"),
                    text.find("a long entity3") + len("a long entity3")), "E"),
            ]})
    ...
    assert contents == ['This O', 'is O', 'entity1 B-E', 'entity2 B-E', 'and O',
                        'a B-E', 'long I-E', 'entity3 I-E']
