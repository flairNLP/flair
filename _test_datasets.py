...
# imdb_path = "../data/IMDb"
# with open(f"{imdb_path}/clean_test/full_unsorted.csv", newline="", encoding="utf-8") as data_file:
...
#     random_list = sorted(sorted_list, key=lambda _: seed.random())
...
# with open(f"{allenoise_path}/full_reduced.csv", newline="", encoding="utf-8") as full_file:
#     data = csv.reader(full_file, delimiter="\t")
#     data_list = []
#     for datum in data:
#         data_list.append(datum)
#     sorted_list = sorted(data_list, key=lambda _: random.random())
    
#     with open(f"{allenoise_path}/new/train.csv", "w", newline="", encoding="utf-8") as train_file:
#         new_data = csv.writer(train_file, delimiter="\t")
#         new_data.writerows(sorted_list[:100000])
#     with open(f"{allenoise_path}/new/test.csv", "w", newline="", encoding="utf-8") as test_file:
#         new_data = csv.writer(test_file, delimiter="\t")
#         new_data.writerows(sorted_list[100000:109247])    
#     with open(f"{allenoise_path}/new/dev.csv", "w", newline="", encoding="utf-8") as dev_file:
#         new_data = csv.writer(dev_file, delimiter="\t")
#         new_data.writerows(sorted_list[109247:])  

# with open(f"{allenoise_path}/new/test.csv", newline="", encoding="utf-8") as test_file:
#     data = csv.reader(test_file, delimiter="\t")
#     data_list = []
#     for datum in data:
...
#     with open(f"{allenoise_path}/new/test_clean.csv", "w", newline="", encoding="utf-8") as new_test_file:
#         new_data = csv.writer(new_test_file, delimiter="\t")
#         new_data.writerows(data_list)

# with open(f"{allenoise_path}/new/test_clean_new.csv", "r", newline="", encoding="utf-8") as test_file:
#     data_test = csv.reader(test_file, delimiter="\t")

#     with open(f"{allenoise_path}/new/train.csv", "r", newline="", encoding="utf-8") as train_file:
#         data_train = csv.reader(train_file, delimiter="\t")
#         train_clean_list = []
#         train_noisy_list = []
#         train_list = []
#         for train in data_train:
#             train_list.append(train)
#             train_clean_list.append(train[2])
#             train_noisy_list.append(train[3])
#         train_clean = set(train_clean_list)
#         train_noisy = set(train_noisy_list)

#     unseen = []
#     new_test = []
#     for test in data_test:
#         if test[2] in train_clean and test[2] in train_noisy:
...
#     print(len(unseen))
    ...
    #     new_test.append(train_list[i])
    #     train_list[i] = unseen[i]

    # with open(f"{allenoise_path}/new/test_clean_new.csv", "w", newline="", encoding="utf-8") as new_test_file:
    #     new_data = csv.writer(new_test_file, delimiter="\t")
    #     new_data.writerows(new_test)
    # with open(f"{allenoise_path}/new/dev_new.csv", "w", newline="", encoding="utf-8") as new_train_file:
    #     new_data = csv.writer(new_train_file, delimiter="\t")
    #     new_data.writerows(train_list)
    ...
    #     if test[2] not in train_clean or test[2] not in train_noisy:
    #         unseen.append(test)
...
#     with open(f"{dbpedia_path}/new/train.csv", "w", newline="", encoding="utf-8") as train_file:
#         new_data = csv.writer(train_file, delimiter="\t")
#         new_data.writerows(sorted_list[:85000])    
#     with open(f"{dbpedia_path}/new/dev.csv", "w", newline="", encoding="utf-8") as dev_file:
#         new_data = csv.writer(dev_file, delimiter="\t")
#         new_data.writerows(sorted_list[85000:95000])  
...
#     with open(f"{dbpedia_path}/new/test.csv", "w", newline="", encoding="utf-8") as test_file:
#         new_data = csv.writer(test_file, delimiter="\t")
#         new_data.writerows(sorted_list[:10000])    
