...
class TextCorpus2(object):
    def __init__(self, path: Path, dictionary: Dictionary, forward: bool = True, character_level: bool = True, random_case_flip : bool = True):
        ...
        self.valid = TextDataset(path / 'valid.txt',dictionary, False,self.forward,self.split_on_char,self.random_case_flip)
        self.test  = TextDataset(path / 'test.txt',dictionary,False,self.forward,self.split_on_char,self.random_case_flip)
    
class LanguageModelTrainer2:
    ...
    def __init__(self,
        ...
        self.corpus: TextCorpus2 = corpus
    ...
    @staticmethod
    def load_from_checkpoint(checkpoint_file: Path, corpus: TextCorpus2, optimizer: Optimizer = SGD):
