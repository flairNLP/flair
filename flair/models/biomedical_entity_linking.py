...
def parse_args():
    ...
    # Required
    parser.add_argument(
        "--mention", type=str, required=True, help="mention to normalize"
    )
    parser.add_argument(
        "--model_name_or_path", required=True, help="Directory for model"
    )
    ...
    parser.add_argument(
        "--dictionary_path", type=str, default=None, help="dictionary path"
    )
